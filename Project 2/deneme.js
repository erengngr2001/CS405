...
class MeshDrawer {
	...
	draw(trans) {
		...
		// Set the enable lighting uniform
		//gl.uniform1i(this.enableLightingLoc, this.enableLighting);
...
const meshFS = `
			...
			{				
				...
				if(showTex && enableLighting){
					...
					vec3 ambientIntensity = ambient * baseColor.rgb; // Calculate ambient light
